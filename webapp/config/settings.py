...
SECRET_KEY = 'django-insecure-(q4rtwn)0eztuv6ub2e%8!%!h*37-vex3))%vjos_w08&cy_5b'
...
# SQLite in a data directory (keep DB file out of repo; ensure dir exists)
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': _db_dir / 'nfc_users.sqlite3',
    }
}
